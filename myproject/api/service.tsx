...
import icon1 from '@/public/images/icon/medical-icons/medical-billing.png'
import icon2 from '@/public/images/icon/medical-icons/medical-codeing.png'
import icon3 from '@/public/images/icon/medical-icons/claims-management.png'
import icon4 from '@/public/images/icon/medical-icons/Credentialing.png'
import icon5 from '@/public/images/icon/medical-icons/charge-posting.png'
import icon6 from '@/public/images/icon/medical-icons/payment-Posting.png'
...
const Services: Service[] = [
  {
    ...
    // thumb1: 'Strategy',
    // thumb2: 'Consultation',
    description: 'Accurate and timely claim submissions with comprehensive follow-up to ensure maximum reimbursement.',
  },
  {
    Id: '2',
    sImg: icon2,
    ...
    // thumb1: 'Management',
    // thumb2: 'Transfer',
    description: 'Certified coders ensuring precise ICD-10, CPT, and HCPCS coding for optimal claim acceptance.',
  },
  {
    Id: '3',
    sImg: icon3,
    ...
    // thumb1: 'Landing Page',
    // thumb2: 'Plugins',
    description: 'Proactive denial management and appeals process to recover lost revenue and prevent future denials.',
  },
  {
    Id: '4',
    sImg: icon4,
    ...
    // thumb1: 'Consultation',
    // thumb2: 'solution',
    description: 'Complete provider enrollment and credentialing services with all major insurance networks.',
  },
  {
    Id: '5',
    sImg: icon5,
    ...
    // thumb1: 'Website',
    // thumb2: 'Mobile App',
    description: 'Accurate and timely charge entry from encounter forms, ensuring all billable services are captured for maximum revenue realization.',
  },
  {
    Id: '6',
    sImg: icon6,
    ...
    description: 'Detailed posting of insurance payments, patient payments, and adjustments with complete reconciliation and reporting.',
  },
  {
    Id: '7',
    sImg: serviceImg02,
